...
export const PowerUp32 = () => {
  return (
    <div className="pt-20 px-6 text-center">
      {/* Header Section */}
      <div className="p-10 rounded-2xl shadow-2xl border border-gray-300 w-full max-w-5xl mx-auto bg-white">
        ...
        <p className="font-bold text-green-600 mt-4">Best suited for:</p>
        ...
        <div className="flex flex-wrap justify-center gap-6 my-6">
          {power32.map((item, index) => (
            <div
              key={index}
              className="p-4 border rounded-lg shadow-md bg-gray-100 w-28"
            >
      ...
      {/* Features Section */}
      <div className="mt-12 p-8 bg-white rounded-2xl shadow-xl border border-gray-300 w-full max-w-5xl mx-auto">
